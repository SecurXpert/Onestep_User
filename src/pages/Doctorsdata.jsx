...
const Doctorsdata = () => {
  ...
  const handleFetchDoctor = async () => {
    try {
      setError('');
      setSuccess('');
      const response = await axios.get(`https://api.onestepmedi.com:8000/doctors/profile/${doctorId}`);
  ...
  const handleUpdateDoctor = async () => {
    try {
      setError('');
      setSuccess('');
      await axios.put(`https://api.onestepmedi.com:8000/doctors/profile/${doctorId}`, formData);
